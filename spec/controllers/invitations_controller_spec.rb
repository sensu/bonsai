...
describe InvitationsController do
  ...
  describe 'GET #accept' do
    ...
    it 'creates admins if the invitation specifies as such' do
      ...
      expect { get :accept, params: {id: invitation.token} }.to change(Contributor.where(admin: true), :count).by(1)
    end
    ...
    it "it doesn't create a new Contributor if the same user already belongs to the CCLA (organization)" do
      ...
      expect do
        get :accept, params: {id: invitation_1.token}
        get :accept, params: {id: invitation_2.token}
